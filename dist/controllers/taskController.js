      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            res.status(500).json({
              message: _context.t0.message || 'Something went wrong while we fetch tasks'
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            res.status(500).json({
              message: _context2.t0.message || 'Something went wrong while we create tasks'
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 10:
            ...
            res.status(500).json({
              message: _context3.t0.message || "Something went wrong while we find the tasks ".concat(id)
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            res.status(500).json({
              message: _context4.t0.message || "Something went wrong while we try to delete the tasks ".concat(id)
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            res.status(500).json({
              message: _context5.t0.message || 'Something went wrong while we try to  find the tasks done '
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            res.status(500).json({
              message: _context6.t0.message || 'Something went wrong while we try to  update the tasks '
            });
